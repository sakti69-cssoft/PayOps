...
- Added PayOps to GitHub Desktop. The app was previously showing FinCore_Digital_Banking; that unrelated repository was preserved. The completed implementation was pushed to https://github.com/sakti69-cssoft/PayOps.git on 20 September 2026; remote main was verified against the local commit. GitHub-hosted CI status could not be read through the unauthenticated API, so no remote CI pass is claimed.
